...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../README.md) / account

# account

## Fileoverview

Central export point for all account management schemas.

## Type Aliases

| Type Alias | Description |
| ------ | ------ |
| [OrganizationServiceStatusRecord](type-aliases/OrganizationServiceStatusRecord.md) | Zod schema for organization service status history records. |
| [Organization](type-aliases/Organization.md) | Zod schema for organization entity. |
