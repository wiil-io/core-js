...
Defined in: src/core/type-definitions/display-order.ts:186
...
| ------ | ------ | ------ |
| <a id="categoryorders"></a> `categoryOrders` | \{ `categoryId`: `string`; `displayOrder`: `number`; \}[] | src/core/type-definitions/display-order.ts:158 |
