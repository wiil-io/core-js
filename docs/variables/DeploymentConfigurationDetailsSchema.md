...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / DeploymentConfigurationDetailsSchema
...
Defined in: src/core/service-configuration/deployment-config.schema.ts:287
