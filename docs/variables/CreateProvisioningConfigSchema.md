...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / CreateProvisioningConfigSchema
...
Defined in: src/core/service-configuration/provisioning-config.ts:145
