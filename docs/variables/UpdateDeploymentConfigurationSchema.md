...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateDeploymentConfigurationSchema
...
Defined in: src/core/service-configuration/deployment-config.schema.ts:200
