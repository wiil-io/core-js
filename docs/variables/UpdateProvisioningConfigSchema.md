...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateProvisioningConfigSchema
...
Defined in: src/core/service-configuration/provisioning-config.ts:173
