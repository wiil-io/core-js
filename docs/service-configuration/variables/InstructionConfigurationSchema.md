...
Defined in: [src/core/service-configuration/instruction-config.schema.ts:72](https://github.com/wiil-io/core-js/blob/09a3d6d4c398397e9996a8872999fad3282747ce/src/core/service-configuration/instruction-config.schema.ts#L72)
