...
Defined in: [src/core/service-configuration/instruction-config.schema.ts:72](https://github.com/wiil-io/core-js/blob/43f9832c8ca9dc8d3a35be8a362c24983a1b73cc/src/core/service-configuration/instruction-config.schema.ts#L72)
