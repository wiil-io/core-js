...
Defined in: [src/core/service-configuration/phone-config.schema.ts:85](https://github.com/wiil-io/core-js/blob/21f78e57f02d188c257d7debf1363466bcfa4c64/src/core/service-configuration/phone-config.schema.ts#L85)
