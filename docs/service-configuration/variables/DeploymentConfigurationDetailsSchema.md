...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:305](https://github.com/wiil-io/core-js/blob/0912d800094d4e3e2e193adfe1e954d82a65fedc/src/core/service-configuration/deployment-config.schema.ts#L305)
