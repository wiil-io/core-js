...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:302](https://github.com/wiil-io/core-js/blob/81a2e002271d89bdaa7b84f1befea192faa0209f/src/core/service-configuration/deployment-config.schema.ts#L302)
