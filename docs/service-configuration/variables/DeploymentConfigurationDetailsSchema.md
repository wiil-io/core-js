...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:305](https://github.com/wiil-io/core-js/blob/84bc94da37a7c071ffcbbcc61f07f2596d6db417/src/core/service-configuration/deployment-config.schema.ts#L305)
