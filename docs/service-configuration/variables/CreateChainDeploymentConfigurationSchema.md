...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:173](https://github.com/wiil-io/core-js/blob/4be5beeca2c5a15e9be2725805032c749f72aacd/src/core/service-configuration/deployment-config.schema.ts#L173)
