...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:176](https://github.com/wiil-io/core-js/blob/b141e1b7fd95038279563ddc8b7255644acdf199/src/core/service-configuration/deployment-config.schema.ts#L176)
