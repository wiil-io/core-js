...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:173](https://github.com/wiil-io/core-js/blob/bf48d7864acd8e7b3e7867ae31da63d5dc26ab46/src/core/service-configuration/deployment-config.schema.ts#L173)
