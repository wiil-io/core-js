...
Defined in: [src/core/service-configuration/agent-config.schema.ts:76](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/service-configuration/agent-config.schema.ts#L76)
