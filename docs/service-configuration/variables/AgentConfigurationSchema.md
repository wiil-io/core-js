...
Defined in: [src/core/service-configuration/agent-config.schema.ts:78](https://github.com/wiil-io/core-js/blob/30ea300b8c5c9afa9ef99fffaae218b767488d67/src/core/service-configuration/agent-config.schema.ts#L78)
