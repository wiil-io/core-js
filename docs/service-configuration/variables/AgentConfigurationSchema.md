...
Defined in: [src/core/service-configuration/agent-config.schema.ts:78](https://github.com/wiil-io/core-js/blob/b184f878c8938357e78881ccc1cdb3c1cc1bceec/src/core/service-configuration/agent-config.schema.ts#L78)
