...
Defined in: [src/core/service-configuration/call-transfer-config.schema.ts:48](https://github.com/wiil-io/core-js/blob/ebd04cb73529c8832076df82c008bfdf400ced2a/src/core/service-configuration/call-transfer-config.schema.ts#L48)
