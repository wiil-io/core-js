...
Defined in: [src/core/service-configuration/call-transfer-config.schema.ts:48](https://github.com/wiil-io/core-js/blob/16f97d4afc9c808249e9e74ff3aad1f67349558b/src/core/service-configuration/call-transfer-config.schema.ts#L48)
