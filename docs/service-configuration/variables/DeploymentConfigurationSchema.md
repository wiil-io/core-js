...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:80](https://github.com/wiil-io/core-js/blob/580be9840674fc43db47bcb0d7cde0e3f86e4124/src/core/service-configuration/deployment-config.schema.ts#L80)
