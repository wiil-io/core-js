...
Defined in: [src/core/service-configuration/provisioning-config.ts:78](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/service-configuration/provisioning-config.ts#L78)
