...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:256](https://github.com/wiil-io/core-js/blob/24feef82ee4591737e3700f46c23e871a410fbc1/src/core/service-configuration/deployment-config.schema.ts#L256)
