...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:256](https://github.com/wiil-io/core-js/blob/dbdfb645457e4fab159a4c3d5050b1d2afe779c3/src/core/service-configuration/deployment-config.schema.ts#L256)
