...
Defined in: [src/core/service-configuration/agent-config.schema.ts:125](https://github.com/wiil-io/core-js/blob/580be9840674fc43db47bcb0d7cde0e3f86e4124/src/core/service-configuration/agent-config.schema.ts#L125)
