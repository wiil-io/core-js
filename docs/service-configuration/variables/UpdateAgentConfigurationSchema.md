...
Defined in: [src/core/service-configuration/agent-config.schema.ts:163](https://github.com/wiil-io/core-js/blob/c39005a6978571a1c92c2a387def93d246a76ba3/src/core/service-configuration/agent-config.schema.ts#L163)
