...
Defined in: [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:61](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L61)
...
| <a id="websiteurl"></a> `websiteUrl?` | `string` | [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:24](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L24) |
| <a id="communicationtype"></a> `communicationType?` | \| [`TEXT`](../../type-definitions/enumerations/OttCommunicationType.md#text) \| [`VOICE`](../../type-definitions/enumerations/OttCommunicationType.md#voice) \| [`UNIFIED`](../../type-definitions/enumerations/OttCommunicationType.md#unified) | [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:25](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L25) |
| <a id="sttconfiguration"></a> `sttConfiguration?` | \| \{ `providerType`: [`SupportedProprietor`](../../type-definitions/enumerations/SupportedProprietor.md); `providerModelId`: `string`; `languageId`: `string`; \} \| `null` | [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:26](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L26) |
| <a id="ttsconfiguration"></a> `ttsConfiguration?` | \| \{ `providerType`: [`SupportedProprietor`](../../type-definitions/enumerations/SupportedProprietor.md); `providerModelId`: `string`; `languageId`: `string`; `voiceId?`: `string`; \} \| `null` | [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:27](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L27) |
| <a id="id"></a> `id` | `string` | [src/core/service-configuration/dynamic\_setup/web-agent-setup.ts:56](https://github.com/wiil-io/core-js/blob/3a057dbb516d45ce94599e33861c329418b4e5b3/src/core/service-configuration/dynamic_setup/web-agent-setup.ts#L56) |
