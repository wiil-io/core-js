...
Defined in: src/core/service-configuration/base-agent-setup.ts:115
...
| <a id="languageid"></a> `languageId` | `string` | src/core/service-configuration/base-agent-setup.ts:73 |
| <a id="voiceid"></a> `voiceId?` | `string` | src/core/service-configuration/base-agent-setup.ts:74 |
