...
type DeploymentConfiguration = {
  ...
  isActive: boolean;
  channel?:   | { id: string; deploymentType: DeploymentType; recordingEnabled: boolean; channelIdentifier: string; createdAt?: number | undefined; updatedAt?: number | undefined; channelName?: string | undefined; } & ({ ...; } | ... 2 more ... | { ...; })
     | null;
  project?:   | {
     name: string;
...
Defined in: [src/core/service-configuration/deployment-config.schema.ts:77](https://github.com/wiil-io/core-js/blob/e764a5e50337be928fa12d95132bc367a4a9284a/src/core/service-configuration/deployment-config.schema.ts#L77)
