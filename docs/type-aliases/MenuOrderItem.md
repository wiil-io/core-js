...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / MenuOrderItem
...
Defined in: src/core/business-mgt/menu.order.schema.ts:162
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/menu.order.schema.ts:50 |
| <a id="menuorderid"></a> `menuOrderId` | `string` | src/core/business-mgt/menu.order.schema.ts:51 |
