...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / CreateBusinessProduct
...
Defined in: src/core/business-mgt/product-config.schema.ts:130
