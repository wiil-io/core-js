...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateMenuOrder
...
Defined in: src/core/business-mgt/menu.order.schema.ts:165
...
| <a id="type"></a> `type?` | \| [`DINE_IN`](../enumerations/MenuOrderType.md#dine_in) \| [`TAKEOUT`](../enumerations/MenuOrderType.md#takeout) \| [`DELIVERY`](../enumerations/MenuOrderType.md#delivery) | - | src/core/business-mgt/menu.order.schema.ts:89 |
| <a id="status"></a> `status?` | \| [`PENDING`](../enumerations/OrderStatus.md#pending) \| [`CONFIRMED`](../enumerations/OrderStatus.md#confirmed) \| [`PREPARING`](../enumerations/OrderStatus.md#preparing) \| [`READY`](../enumerations/OrderStatus.md#ready) \| [`OUT_FOR_DELIVERY`](../enumerations/OrderStatus.md#out_for_delivery) \| [`COMPLETED`](../enumerations/OrderStatus.md#completed) \| [`CANCELLED`](../enumerations/OrderStatus.md#cancelled) \| [`RETURNED`](../enumerations/OrderStatus.md#returned) | - | src/core/business-mgt/menu.order.schema.ts:90 |
...
| <a id="id"></a> `id` | `string` | - | src/core/business-mgt/menu.order.schema.ts:147 |
