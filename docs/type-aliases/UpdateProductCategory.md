...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateProductCategory
...
Defined in: src/core/business-mgt/product-config.schema.ts:128
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/product-config.schema.ts:99 |
