...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / SearchablePaginationRequest
...
Defined in: src/request/models/paginated-result.schema.ts:106
...
| <a id="search"></a> `search?` | `string` | src/request/models/paginated-result.schema.ts:97 |
| <a id="searchfields"></a> `searchFields?` | `string`[] | src/request/models/paginated-result.schema.ts:98 |
