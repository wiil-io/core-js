...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / WebChannelType
...
Defined in: src/core/service-configuration/interaction-channels.schema.ts:133
