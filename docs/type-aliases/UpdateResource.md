...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateResource
...
Defined in: src/core/business-mgt/reservation-resource.schema.ts:111
...
| <a id="resourcetype"></a> `resourceType?` | \| [`TABLE`](../enumerations/ResourceType.md#table) \| [`ROOM`](../enumerations/ResourceType.md#room) \| [`RENTALS`](../enumerations/ResourceType.md#rentals) \| [`RESOURCE`](../enumerations/ResourceType.md#resource) | src/core/business-mgt/reservation-resource.schema.ts:67 |
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/reservation-resource.schema.ts:106 |
