...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / DeploymentChannelUpdateRequest
...
Defined in: src/core/service-configuration/interaction-channels.schema.ts:326
