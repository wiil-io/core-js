...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateMenuCategory
...
Defined in: src/core/business-mgt/menu-config.schema.ts:130
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/menu-config.schema.ts:90 |
