...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / AgentConfiguration
...
Defined in: src/core/service-configuration/agent-config.schema.ts:75
