...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / UpdateBusinessMenuItem
...
Defined in: src/core/business-mgt/menu-config.schema.ts:135
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/menu-config.schema.ts:99 |
