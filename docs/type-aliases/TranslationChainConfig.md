...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / TranslationChainConfig
...
Defined in: src/core/service-configuration/provisioning-config.ts:235
...
| <a id="istranslation"></a> `isTranslation` | `boolean` | - | src/core/service-configuration/provisioning-config.ts:229 |
