...
[Wiil Platform JavaScript Data Model Definitions - API Reference](../globals.md) / ProvisioningConfigChain
...
Defined in: src/core/service-configuration/provisioning-config.ts:116
