...
Defined in: [src/core/business-mgt/product-management/product-config.schema.ts:464](https://github.com/wiil-io/core-js/blob/93399ddfe88b7931620744392516237a259c457f/src/core/business-mgt/product-management/product-config.schema.ts#L464)
...
| <a id="id"></a> `id` | `string` | - | [src/core/business-mgt/product-management/product-config.schema.ts:359](https://github.com/wiil-io/core-js/blob/93399ddfe88b7931620744392516237a259c457f/src/core/business-mgt/product-management/product-config.schema.ts#L359) |
