...
Defined in: src/core/business-mgt/property-management/property-config.schema.ts:427
...
| ------ | ------ | ------ | ------ |
| `propertyCategory` | \{ `id`: `string`; `createdAt?`: `number`; `updatedAt?`: `number`; `name`: `string`; `description?`: `string`; `propertyType`: [`PropertyType`](../../type-definitions/enumerations/PropertyType.md); `displayOrder?`: `number`; `isDefault`: `boolean`; \} | `PropertyCategorySchema` | src/core/business-mgt/property-management/property-config.schema.ts:416 |
| `propertyCategory.id` | `string` | - | [src/core/base.schema.ts:8](https://github.com/wiil-io/core-js/blob/ebd04cb73529c8832076df82c008bfdf400ced2a/src/core/base.schema.ts#L8) |
| `propertyCategory.createdAt?` | `number` | - | [src/core/base.schema.ts:9](https://github.com/wiil-io/core-js/blob/ebd04cb73529c8832076df82c008bfdf400ced2a/src/core/base.schema.ts#L9) |
| `propertyCategory.updatedAt?` | `number` | - | [src/core/base.schema.ts:10](https://github.com/wiil-io/core-js/blob/ebd04cb73529c8832076df82c008bfdf400ced2a/src/core/base.schema.ts#L10) |
| `propertyCategory.name` | `string` | - | src/core/business-mgt/property-management/property-config.schema.ts:37 |
| `propertyCategory.description?` | `string` | - | src/core/business-mgt/property-management/property-config.schema.ts:38 |
| `propertyCategory.propertyType` | [`PropertyType`](../../type-definitions/enumerations/PropertyType.md) | - | src/core/business-mgt/property-management/property-config.schema.ts:39 |
| `propertyCategory.displayOrder?` | `number` | - | src/core/business-mgt/property-management/property-config.schema.ts:40 |
| `propertyCategory.isDefault` | `boolean` | - | src/core/business-mgt/property-management/property-config.schema.ts:41 |
