...
Defined in: src/core/business-mgt/service-management/service-appointment.schema.ts:106
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/service-management/service-appointment.schema.ts:96 |
| <a id="cancelreason"></a> `cancelReason?` | `string` \| `null` | src/core/business-mgt/service-management/service-appointment.schema.ts:97 |
