...
Defined in: [src/core/business-mgt/product-management/product-config.schema.ts:460](https://github.com/wiil-io/core-js/blob/0a3c1fe21edf560853760c0ca06994b85d3d2555/src/core/business-mgt/product-management/product-config.schema.ts#L460)
...
| <a id="categoryid"></a> `categoryId?` | `string` | - | [src/core/business-mgt/product-management/product-config.schema.ts:375](https://github.com/wiil-io/core-js/blob/0a3c1fe21edf560853760c0ca06994b85d3d2555/src/core/business-mgt/product-management/product-config.schema.ts#L375) |
| <a id="placement"></a> `placement?` | \{ `placementIntent`: \{ `mode`: \| `"BEGINNING"` \| `"END"` \| `"KEEP_CURRENT"` \| `"BEFORE_ITEM"` \| `"AFTER_ITEM"` \| `"ABSOLUTE_INDEX"`; \}; `anchorItemId?`: `string` \| `null`; `absoluteIndex?`: `number` \| `null`; \} | - | [src/core/business-mgt/product-management/product-config.schema.ts:376](https://github.com/wiil-io/core-js/blob/0a3c1fe21edf560853760c0ca06994b85d3d2555/src/core/business-mgt/product-management/product-config.schema.ts#L376) |
...
| <a id="id"></a> `id` | `string` | - | [src/core/business-mgt/product-management/product-config.schema.ts:384](https://github.com/wiil-io/core-js/blob/0a3c1fe21edf560853760c0ca06994b85d3d2555/src/core/business-mgt/product-management/product-config.schema.ts#L384) |
