...
Defined in: [src/core/business-mgt/product-config.schema.ts:119](https://github.com/wiil-io/core-js/blob/5c8d967933edfe6fc001aa769a11443695981d49/src/core/business-mgt/product-config.schema.ts#L119)
...
| <a id="categoryid"></a> `categoryId?` | `string` | [src/core/business-mgt/product-config.schema.ts:102](https://github.com/wiil-io/core-js/blob/5c8d967933edfe6fc001aa769a11443695981d49/src/core/business-mgt/product-config.schema.ts#L102) |
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/product-config.schema.ts:110](https://github.com/wiil-io/core-js/blob/5c8d967933edfe6fc001aa769a11443695981d49/src/core/business-mgt/product-config.schema.ts#L110) |
