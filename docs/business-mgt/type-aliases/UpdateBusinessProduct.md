...
Defined in: src/core/business-mgt/product-management/product-config.schema.ts:460
...
| <a id="id"></a> `id` | `string` | - | src/core/business-mgt/product-management/product-config.schema.ts:384 |
