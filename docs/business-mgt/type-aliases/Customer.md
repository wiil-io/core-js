...
Defined in: src/core/business-mgt/customer-management/customer.schema.ts:101
...
| <a id="preferred_contact_method"></a> `preferred_contact_method` | [`PreferredContactMethod`](../../type-definitions/enumerations/PreferredContactMethod.md) | src/core/business-mgt/customer-management/customer.schema.ts:63 |
...
| <a id="channelid"></a> `channelId?` | `string` \| `null` | src/core/business-mgt/customer-management/customer.schema.ts:68 |
