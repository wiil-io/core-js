...
Defined in: src/core/business-mgt/reservation-mgt/reservation-slot-query.schema.ts:360
...
| ------ | ------ | ------ |
| <a id="resourcetype"></a> `resourceType` | [`RENTAL`](../../type-definitions/enumerations/ResourceType.md#rental) | src/core/business-mgt/reservation-mgt/reservation-slot-query.schema.ts:323 |
| <a id="pickupdate"></a> `pickupDate` | `string` | src/core/business-mgt/reservation-mgt/reservation-slot-query.schema.ts:324 |
| <a id="returndate"></a> `returnDate` | `string` | src/core/business-mgt/reservation-mgt/reservation-slot-query.schema.ts:325 |
| <a id="generatedat"></a> `generatedAt` | `number` | src/core/business-mgt/reservation-mgt/reservation-slot-query.schema.ts:326 |
