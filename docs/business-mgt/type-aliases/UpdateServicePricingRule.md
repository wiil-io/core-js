...
Defined in: src/core/business-mgt/service-management/service-pricing-rule.schema.ts:137
...
| <a id="applylevel"></a> `applyLevel?` | \| [`ITEM`](../../type-definitions/enumerations/PricingRuleApplyLevel.md#item) \| [`ORDER`](../../type-definitions/enumerations/PricingRuleApplyLevel.md#order) | - | src/core/business-mgt/service-management/service-pricing-rule.schema.ts:73 |
...
| <a id="id"></a> `id` | `string` | - | src/core/business-mgt/service-management/service-pricing-rule.schema.ts:127 |
