...
Defined in: src/core/business-mgt/product-management/product-variant.schema.ts:148
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/product-management/product-variant.schema.ts:138 |
