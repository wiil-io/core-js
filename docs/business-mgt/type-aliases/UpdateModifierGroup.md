...
Defined in: src/core/business-mgt/menu-management/modifier.schema.ts:388
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/menu-management/modifier.schema.ts:358 |
