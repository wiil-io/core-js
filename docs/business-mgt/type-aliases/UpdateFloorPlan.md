...
Defined in: src/core/business-mgt/reservation-mgt/reservation-table-layout.schema.ts:97
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/reservation-mgt/reservation-table-layout.schema.ts:87 |
