...
Defined in: [src/core/business-mgt/service-config.schema.ts:75](https://github.com/wiil-io/core-js/blob/465d307305563ec9efb5deeecc4be24f1e371aa2/src/core/business-mgt/service-config.schema.ts#L75)
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/service-config.schema.ts:24](https://github.com/wiil-io/core-js/blob/465d307305563ec9efb5deeecc4be24f1e371aa2/src/core/business-mgt/service-config.schema.ts#L24) |
