...
Defined in: src/core/business-mgt/customer-management/customer-group.schema.ts:61
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/customer-management/customer-group.schema.ts:52 |
