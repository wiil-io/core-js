...
Defined in: src/core/business-mgt/reservation-mgt/assignment/reservation-rental-assignment.schema.ts:119
...
| <a id="assignmenttype"></a> `assignmentType?` | \| [`SOFT`](../enumerations/RentalAssignmentType.md#soft) \| [`HARD`](../enumerations/RentalAssignmentType.md#hard) | src/core/business-mgt/reservation-mgt/assignment/reservation-rental-assignment.schema.ts:79 |
| <a id="status"></a> `status?` | \| [`ASSIGNED`](../enumerations/RentalAssignmentStatus.md#assigned) \| [`REASSIGNED`](../enumerations/RentalAssignmentStatus.md#reassigned) \| [`RELEASED`](../enumerations/RentalAssignmentStatus.md#released) | src/core/business-mgt/reservation-mgt/assignment/reservation-rental-assignment.schema.ts:80 |
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/reservation-mgt/assignment/reservation-rental-assignment.schema.ts:109 |
