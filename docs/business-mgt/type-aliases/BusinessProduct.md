...
Defined in: [src/core/business-mgt/product-config.schema.ts:125](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L125)
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/product-config.schema.ts:49](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L49) |
...
| <a id="categoryid"></a> `categoryId` | `string` | [src/core/business-mgt/product-config.schema.ts:57](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L57) |
| <a id="category"></a> `category?` | \{ `createdAt?`: `number`; `updatedAt?`: `number`; `id`: `string`; `name`: `string`; `description?`: `string`; `displayOrder?`: `number`; `isDefault`: `boolean`; \} | [src/core/business-mgt/product-config.schema.ts:58](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L58) |
...
| `category.id` | `string` | [src/core/business-mgt/product-config.schema.ts:20](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L20) |
| `category.name` | `string` | [src/core/business-mgt/product-config.schema.ts:21](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L21) |
| `category.description?` | `string` | [src/core/business-mgt/product-config.schema.ts:22](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L22) |
| `category.displayOrder?` | `number` | [src/core/business-mgt/product-config.schema.ts:23](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L23) |
| `category.isDefault` | `boolean` | [src/core/business-mgt/product-config.schema.ts:24](https://github.com/wiil-io/core-js/blob/376fc7af7b7b381dfd7c674140b3d9eb8e4bd0c3/src/core/business-mgt/product-config.schema.ts#L24) |
