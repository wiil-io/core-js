...
Defined in: src/core/business-mgt/reservation-mgt/reservation-table.schema.ts:81
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/reservation-mgt/reservation-table.schema.ts:72 |
