...
Defined in: src/core/business-mgt/menu-management/menu-catalog.schema.ts:69
...
| ------ | ------ | ------ |
| <a id="category"></a> `category` | \{ `id`: `string`; `createdAt?`: `number`; `updatedAt?`: `number`; `name`: `string`; `description?`: `string`; `displayOrder?`: `number`; `channelMappings?`: \| \{ `channelId`: `string`; `externalCategoryId`: `string`; \}[] \| `null`; \} | src/core/business-mgt/menu-management/menu-catalog.schema.ts:53 |
