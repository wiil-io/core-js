...
Defined in: [src/core/business-mgt/menu-management/menu-set.schema.ts:281](https://github.com/wiil-io/core-js/blob/16f97d4afc9c808249e9e74ff3aad1f67349558b/src/core/business-mgt/menu-management/menu-set.schema.ts#L281)
...
| <a id="targetingmode"></a> `targetingMode?` | \| [`EXPLICIT`](../enumerations/MenuSetTargetingMode.md#explicit) \| [`SELECTOR`](../enumerations/MenuSetTargetingMode.md#selector) | [src/core/business-mgt/menu-management/menu-set.schema.ts:170](https://github.com/wiil-io/core-js/blob/16f97d4afc9c808249e9e74ff3aad1f67349558b/src/core/business-mgt/menu-management/menu-set.schema.ts#L170) |
| <a id="pricingmode"></a> `pricingMode?` | \| [`FIXED`](../enumerations/MenuSetPricingMode.md#fixed) \| [`SUM_OF_ITEMS`](../enumerations/MenuSetPricingMode.md#sum_of_items) | [src/core/business-mgt/menu-management/menu-set.schema.ts:171](https://github.com/wiil-io/core-js/blob/16f97d4afc9c808249e9e74ff3aad1f67349558b/src/core/business-mgt/menu-management/menu-set.schema.ts#L171) |
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/menu-management/menu-set.schema.ts:269](https://github.com/wiil-io/core-js/blob/16f97d4afc9c808249e9e74ff3aad1f67349558b/src/core/business-mgt/menu-management/menu-set.schema.ts#L269) |
