...
Defined in: src/core/business-mgt/service-management/business-service-config.schema.ts:226
...
| <a id="id"></a> `id` | `string` | - | src/core/business-mgt/service-management/business-service-config.schema.ts:219 |
