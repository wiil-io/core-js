...
Defined in: [src/core/business-mgt/service-management/service-appointment.schema.ts:132](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/service-appointment.schema.ts#L132)
...
| `appointment.cancelReason?` | `string` \| `null` | [src/core/business-mgt/service-management/service-appointment.schema.ts:71](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/service-appointment.schema.ts#L71) |
...
| <a id="additionalinfo"></a> `additionalInfo` | \{ `id`: `string`; `createdAt?`: `number`; `updatedAt?`: `number`; `businessServiceId`: `string`; `appointmentId`: `string`; `customerId`: `string`; `data`: `Record`\<`string`, `any`\>; \} | [src/core/business-mgt/service-management/service-appointment.schema.ts:129](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/service-appointment.schema.ts#L129) |
| `additionalInfo.id` | `string` | [src/core/base.schema.ts:8](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/base.schema.ts#L8) |
| `additionalInfo.createdAt?` | `number` | [src/core/base.schema.ts:9](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/base.schema.ts#L9) |
| `additionalInfo.updatedAt?` | `number` | [src/core/base.schema.ts:10](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/base.schema.ts#L10) |
| `additionalInfo.businessServiceId` | `string` | [src/core/business-mgt/service-management/appointment-additional-info.schema.ts:56](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/appointment-additional-info.schema.ts#L56) |
| `additionalInfo.appointmentId` | `string` | [src/core/business-mgt/service-management/appointment-additional-info.schema.ts:57](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/appointment-additional-info.schema.ts#L57) |
| `additionalInfo.customerId` | `string` | [src/core/business-mgt/service-management/appointment-additional-info.schema.ts:58](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/appointment-additional-info.schema.ts#L58) |
| `additionalInfo.data` | `Record`\<`string`, `any`\> | [src/core/business-mgt/service-management/appointment-additional-info.schema.ts:59](https://github.com/wiil-io/core-js/blob/1ae3602f60f2ec3cdaf01f3ee2e0b52063a29f6d/src/core/business-mgt/service-management/appointment-additional-info.schema.ts#L59) |
