...
Defined in: [src/core/business-mgt/menu-management/menu.order.schema.ts:223](https://github.com/wiil-io/core-js/blob/24feef82ee4591737e3700f46c23e871a410fbc1/src/core/business-mgt/menu-management/menu.order.schema.ts#L223)
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/menu-management/menu.order.schema.ts:69](https://github.com/wiil-io/core-js/blob/24feef82ee4591737e3700f46c23e871a410fbc1/src/core/business-mgt/menu-management/menu.order.schema.ts#L69) |
| <a id="menuorderid"></a> `menuOrderId` | `string` | [src/core/business-mgt/menu-management/menu.order.schema.ts:70](https://github.com/wiil-io/core-js/blob/24feef82ee4591737e3700f46c23e871a410fbc1/src/core/business-mgt/menu-management/menu.order.schema.ts#L70) |
