...
Defined in: [src/core/business-mgt/menu.order.schema.ts:161](https://github.com/wiil-io/core-js/blob/1224c87015d28d600db311ffd86ba504fdd5dc04/src/core/business-mgt/menu.order.schema.ts#L161)
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/menu.order.schema.ts:50](https://github.com/wiil-io/core-js/blob/1224c87015d28d600db311ffd86ba504fdd5dc04/src/core/business-mgt/menu.order.schema.ts#L50) |
| <a id="menuorderid"></a> `menuOrderId` | `string` | [src/core/business-mgt/menu.order.schema.ts:51](https://github.com/wiil-io/core-js/blob/1224c87015d28d600db311ffd86ba504fdd5dc04/src/core/business-mgt/menu.order.schema.ts#L51) |
