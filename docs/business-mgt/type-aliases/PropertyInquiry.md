...
Defined in: src/core/business-mgt/property-inquiry.schema.ts:129
...
| <a id="inquirytype"></a> `inquiryType` | [`PropertyInquiryType`](../../type-definitions/enumerations/PropertyInquiryType.md) | src/core/business-mgt/property-inquiry.schema.ts:54 |
...
| <a id="status"></a> `status` | [`PropertyInquiryStatus`](../../type-definitions/enumerations/PropertyInquiryStatus.md) | src/core/business-mgt/property-inquiry.schema.ts:59 |
