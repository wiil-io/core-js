...
Defined in: src/core/business-mgt/product-management/product-display.schema.ts:89
...
| <a id="stockstatus"></a> `stockStatus` | [`StockStatus`](../../type-definitions/enumerations/StockStatus.md) | src/core/business-mgt/product-management/product-display.schema.ts:28 |
