...
Defined in: [src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts:133](https://github.com/wiil-io/core-js/blob/c39005a6978571a1c92c2a387def93d246a76ba3/src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts#L133)
...
| <a id="placement"></a> `placement?` | \{ `placementIntent`: \{ `mode`: \| `"BEGINNING"` \| `"END"` \| `"KEEP_CURRENT"` \| `"BEFORE_ITEM"` \| `"AFTER_ITEM"` \| `"ABSOLUTE_INDEX"`; \}; `anchorItemId?`: `string` \| `null`; `absoluteIndex?`: `number` \| `null`; \} | - | [src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts:114](https://github.com/wiil-io/core-js/blob/c39005a6978571a1c92c2a387def93d246a76ba3/src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts#L114) |
...
| <a id="id"></a> `id` | `string` | - | [src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts:122](https://github.com/wiil-io/core-js/blob/c39005a6978571a1c92c2a387def93d246a76ba3/src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts#L122) |
