...
Defined in: src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts:135
...
| <a id="id"></a> `id` | `string` | - | src/core/business-mgt/menu-management/menu-pricing-rule.schema.ts:124 |
