...
Defined in: [src/core/business-mgt/product-management/product-set.schema.ts:276](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/business-mgt/product-management/product-set.schema.ts#L276)
...
| <a id="targetingmode"></a> `targetingMode?` | \| [`EXPLICIT`](../enumerations/ProductSetTargetingMode.md#explicit) \| [`SELECTOR`](../enumerations/ProductSetTargetingMode.md#selector) | [src/core/business-mgt/product-management/product-set.schema.ts:177](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/business-mgt/product-management/product-set.schema.ts#L177) |
| <a id="pricingmode"></a> `pricingMode?` | \| [`FIXED`](../enumerations/ProductSetPricingMode.md#fixed) \| [`SUM_OF_ITEMS`](../enumerations/ProductSetPricingMode.md#sum_of_items) | [src/core/business-mgt/product-management/product-set.schema.ts:178](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/business-mgt/product-management/product-set.schema.ts#L178) |
...
| <a id="items"></a> `items?` | \| \{ `productId`: `string`; `productVariantId?`: `string` \| `null`; `quantity`: `number`; `isRequired`: `boolean`; `displayOrder?`: `number`; \}[] \| `null` | [src/core/business-mgt/product-management/product-set.schema.ts:180](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/business-mgt/product-management/product-set.schema.ts#L180) |
...
| <a id="id"></a> `id` | `string` | [src/core/business-mgt/product-management/product-set.schema.ts:264](https://github.com/wiil-io/core-js/blob/43da06db5074f70ed30c699cea7fe6848eefa005/src/core/business-mgt/product-management/product-set.schema.ts#L264) |
