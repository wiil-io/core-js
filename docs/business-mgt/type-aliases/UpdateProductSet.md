...
Defined in: src/core/business-mgt/product-management/product-set.schema.ts:276
...
| <a id="targetingmode"></a> `targetingMode?` | \| [`EXPLICIT`](../enumerations/ProductSetTargetingMode.md#explicit) \| [`SELECTOR`](../enumerations/ProductSetTargetingMode.md#selector) | src/core/business-mgt/product-management/product-set.schema.ts:177 |
| <a id="pricingmode"></a> `pricingMode?` | \| [`FIXED`](../enumerations/ProductSetPricingMode.md#fixed) \| [`SUM_OF_ITEMS`](../enumerations/ProductSetPricingMode.md#sum_of_items) | src/core/business-mgt/product-management/product-set.schema.ts:178 |
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/product-management/product-set.schema.ts:264 |
