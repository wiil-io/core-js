...
Defined in: [src/core/business-mgt/menu-management/menu-item-variant.schema.ts:101](https://github.com/wiil-io/core-js/blob/43f9832c8ca9dc8d3a35be8a362c24983a1b73cc/src/core/business-mgt/menu-management/menu-item-variant.schema.ts#L101)
...
| <a id="ordercount"></a> `orderCount?` | `number` \| `null` | [src/core/business-mgt/menu-management/menu-item-variant.schema.ts:66](https://github.com/wiil-io/core-js/blob/43f9832c8ca9dc8d3a35be8a362c24983a1b73cc/src/core/business-mgt/menu-management/menu-item-variant.schema.ts#L66) |
| <a id="recentordercount"></a> `recentOrderCount?` | `number` \| `null` | [src/core/business-mgt/menu-management/menu-item-variant.schema.ts:67](https://github.com/wiil-io/core-js/blob/43f9832c8ca9dc8d3a35be8a362c24983a1b73cc/src/core/business-mgt/menu-management/menu-item-variant.schema.ts#L67) |
| <a id="lastorderedat"></a> `lastOrderedAt?` | `number` \| `null` | [src/core/business-mgt/menu-management/menu-item-variant.schema.ts:68](https://github.com/wiil-io/core-js/blob/43f9832c8ca9dc8d3a35be8a362c24983a1b73cc/src/core/business-mgt/menu-management/menu-item-variant.schema.ts#L68) |
