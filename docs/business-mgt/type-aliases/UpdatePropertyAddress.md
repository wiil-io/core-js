...
Defined in: src/core/business-mgt/property-management/property-config.schema.ts:396
...
| <a id="id"></a> `id` | `string` | src/core/business-mgt/property-management/property-config.schema.ts:365 |
