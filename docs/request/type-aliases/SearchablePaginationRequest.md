...
Defined in: [src/request/models/paginated-result.schema.ts:104](https://github.com/wiil-io/core-js/blob/f3384956e14bafdd1347e2d2649f1299435f6e02/src/request/models/paginated-result.schema.ts#L104)
...
| <a id="search"></a> `search?` | `string` | [src/request/models/paginated-result.schema.ts:95](https://github.com/wiil-io/core-js/blob/f3384956e14bafdd1347e2d2649f1299435f6e02/src/request/models/paginated-result.schema.ts#L95) |
| <a id="searchfields"></a> `searchFields?` | `string`[] | [src/request/models/paginated-result.schema.ts:96](https://github.com/wiil-io/core-js/blob/f3384956e14bafdd1347e2d2649f1299435f6e02/src/request/models/paginated-result.schema.ts#L96) |
