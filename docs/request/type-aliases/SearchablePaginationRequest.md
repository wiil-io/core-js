...
Defined in: [src/request/models/paginated-result.schema.ts:104](https://github.com/wiil-io/core-js/blob/550e0fa2b47c8f9bd959a063f47a5f303ef25dfb/src/request/models/paginated-result.schema.ts#L104)
...
| <a id="search"></a> `search?` | `string` | [src/request/models/paginated-result.schema.ts:95](https://github.com/wiil-io/core-js/blob/550e0fa2b47c8f9bd959a063f47a5f303ef25dfb/src/request/models/paginated-result.schema.ts#L95) |
| <a id="searchfields"></a> `searchFields?` | `string`[] | [src/request/models/paginated-result.schema.ts:96](https://github.com/wiil-io/core-js/blob/550e0fa2b47c8f9bd959a063f47a5f303ef25dfb/src/request/models/paginated-result.schema.ts#L96) |
