...
export const MenuOrderSchema = BaseModelSchema.safeExtend({
    ...
    customer: OrderCustomerSchema.nullable().default(null).describe("Populated customer information for convenient access. Includes name, contact details, and delivery address from order.schema.ts."),
    ...
    // Integration
    externalOrderId: z.string().nullable().default(null).describe("Order ID from external system (third-party delivery platform, POS system). Enables order synchronization and cross-platform tracking."),
