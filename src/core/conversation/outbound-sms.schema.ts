 ...
 */
export const SmsRequestSchema = BaseModelSchemaWithAudit.safeExtend({
    ...
    from: z.string().nullable().optional().describe("Sender phone number in E.164 format displayed to the recipient. Must be a verified SMS-enabled number owned by the organization. Uses default from phoneConfigurationId if omitted."),
